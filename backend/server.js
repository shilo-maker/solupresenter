...
sequelize.authenticate()
  .then(async () => {
    ...
    // One-time migration: apply Spanish translations
    try {
      const applySpanishTranslations = require('./migrations/apply-spanish-translations');
      await applySpanishTranslations(Song);
    } catch (err) {
