...
const DraggableStageElement = ({
  ...
  // Element type display names and colors
  const elementConfig = {
  ...
  const config = elementConfig[elementType] || { label: elementType, color: '#6366f1' };
